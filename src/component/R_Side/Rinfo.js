...
const RInfo = () => {
    ...
    const msg_messages = [
        '!픽 [숫자] [제목] (ex. !픽 1 마치오브피어)', '다음 선곡 까지 쿨타임은 30초, 최대 3곡 선곡 가능', ['황금열쇠 칸을 밟을 때 수행할 미션을', <br key='break_1'/>, '투네이션 후원으로 추가가 가능합니다.'], '한 바퀴가 끝나면 3분간 휴식시간을 가집니다.', ['첫바퀴 출발 이후 4시간 초과 시,', <br key='break_2'/>, '일반 주사위 대신 전진 주사위를 사용합니다.'], ['별명으로 선곡 시 모두(특히 방장)가 납득해야 합니다.', <br key='break_3'/>, '그렇지 못한 경우 방장이 자의적으로 선곡합니다.']
    ]
